var app = (function () {
        ...
        c() {
          (t = w("header")),
            ...
            M(
              u,
              "class",
              "font-Namuko text-3xl font-bold flex-grow text-center flex-1" //font for big text title
            ),
      ...
      (u = new Bt({})),
      {
        c() {
          (n = w("p")),
            ...
            (s = w("p")),
            (s.innerHTML =
              '<p class="mb-3">If you\'ve enjoyed playing Revo Heardle, then please consider supporting the <a href="https://ko-fi.com/heardle">real Heardle devs</a> as this project is based on their work.</p>'),
            (i = x()),
            (o = w("div")),
            Q(a.$$.fragment),
            (l = x()),
  ...
  const Vt = {
    ...
    Jt = [
      ...
      "Rukia yo, watashi wa ureshii", // First try
      "So close from being perfect!!",
      "Third time's the charm!",
      "Time to jump back into the abyss.",
      "I understand, sometimes his songs sound the same.",
      ...
      (O = new Rt({})),
      {
        c() {
          ...
          (o = x()),
            ...
            (m = w("div")),
            (k = w("div")),
            (k.textContent = "Next Revo song in:"),
            (b = x()),
            Q(S.$$.fragment),
            (D = x()),
            (T = w("div")),
  ...
  function an(e) {
    ...
    return {
      c() {
        (t = _("You got today's Revo Heardle within the first ")),
          (n = _(s)),
          (r = _(" seconds."));
      },
      m(e, s) {
  ...
  function ln(e) {
    ...
    return {
      c() {
        (t = _("You got today's Revo Heardle within ")), //win screen 
          (n = _(o)),
          (r = _("\n                second")),
          (s = _(a)),
          (i = _("."));
  ...
  function un(t) {
    ...
    return {
      c() {
        n = _("You didn't get today's Revo Heardle, but hey, at least you learned a new song. Better luck tomorrow!"); //lose screen
      },
      m(e, t) {
        g(e, n, t);
      },
  ...
  const  Cn = ue([
    ...
    "Chronicle - Shijin Ballad no Higeki/詩人バラッドの悲劇",
    "Chronicle - Arbelge no Tatakai/アーベルジュの戦い",	
    "Chronicle - Juhyou no Kimi ~Itetsuita Majo/樹氷の君～凍てついた魔女",
    "Chronicle - Ao to Shiro no Kyoukaisen/蒼と白の境界線",
    "Chronicle - Raijin no Hidari Ude/雷神の左腕",
    "Chronicle - Shoujo Ningyou/少女人形",
    "Chronicle - Kimi ga Umaretekuru Sekai/キミが生まれてくる世界",
    "Chronicle - Natsu no Shigure/夏の時雨",
    "Thanatos - Sound Horizon [mode：Thanatos]",
    "Thanatos - Soko ni Aru Fuukei/そこにある風景",		
    "Thanatos - Kowareta Marionette/壊れたマリオネット",		
    "Thanatos - Giniro no Basha/銀色の馬車",			
    "Thanatos - Rinne no Sunadokei/輪廻の砂時計",		
    "Thanatos - Sango no Shiro/珊瑚の城",			
    "Thanatos - Thanatos no Gensou/タナトスの幻想",		
    "Lost - Sound Horizon [mode：Lost]",
    "Lost - White Illusion/白の幻影",		
    "Lost - Koibito wo Uchiotoshita Hi/恋人を射ち堕とした日",
    "Lost - Mahoutsukai Sarabant/魔法使いサラバント",	
    "Lost - Ori no Naka no Yuugi/檻の中の遊戯",	
    "Lost - Kioku no Minasoko/記憶の水底",		
    "Lost - Ushinawareshi Uta/失われし詩",		
    "Lost - Hiiro no Hana/緋色の花",			
    "Lost - Yurikago/ゆりかご",				
    "Lost - Eien no Shounen/永遠の少年",		
    "Lost - Wasuremono/忘レモノ",			
    "Lost - Wasuremono wa Arimasenka/忘レモノハ在リマセンカ",
    "Pico Magic - Onegai!! Pico Majin☆/お願いっ！ぴこ魔神☆",
    "Pico Magic - PicoDJ☆/ぴこDJ☆",
    "Pico Magic - Thanatos no Gensou wa Owaranai.../タナトスの幻想は終わらない･･･",
    "Reloaded - ...Reloaded",
    "Reloaded - Yaneura no Shoujo/屋根裏の少女",
    "Reloaded - Ori no Naka no Yuugi/檻の中の遊戯",
    "Reloaded - Ori no Naka no Hana/檻の中の花",
    "Elysion - Ark",
    "Elysion - Eru no Ehon ~Majo to Lafrenze~/エルの絵本【魔女とラフレンツェ】",
    "Elysion - Baroque",
    "Elysion - Eru no Rakuen [Side:E]/エルの楽園［→side:E→］",		
    "Elysion - Eru no Shouzou/エルの肖像",
    "Elysion - Yield",
    "Elysion - Eru no Tenbin/エルの天秤",				
    "Elysion - Sacrifice",		
    "Elysion - Eru no Ehon ~Fuebuki Otoko to Parade~/エルの絵本【笛吹き男とパレード】",
    "Elysion - Stardust",					
    "Elysion - Eru no Rakuen [Side:A]/エルの楽園［→side:A→］",		
  	"Elysion - Track 44 (Bonus Track)/ボーナストラック",
    "Roman - Asa to Yoru no Monogatari/朝と夜の物語",				
    "Roman - Honoo/焔",
    "Roman - Miezaru Ude/見えざる腕",
    "Roman - Norowareshi Houseki/呪われし宝石",
    "Roman - Hoshikuzu no Kawahimo/星屑の革紐",
    "Roman - Hiiro no Fuusha/緋色の風車",
    "Roman - Tenshi no Chouzou/天使の彫像",
    "Roman - Utsukushiki Mono/美しきもの",
    "Roman - Yorokobi to Kanashimi no Budoushu/歓びと哀しみの葡萄酒",
    "Roman - Tasogare no Kenja/黄昏の賢者",
    "Roman - 11Moji no Dengon/11文字の伝言",
    "Roman - Yaneura Monogatari/屋根裏物語",
    "Moira - Meiou ~Thanatos~/冥王",
    "Moira - Jinsei wa Ireko Ningyou ~Matryoshka~/人生は入れ子人形",
    "Moira - Shinwa ~Mythos~/神話",
    "Moira - Unmei no Futago ~Didymoi~/運命の双子",
    "Moira - Dorei Ichiba ~Douloi~/奴隷市場",
    "Moira - Raijin Iki no Eiyuu ~Leontius~/雷神域の英雄",
    "Moira - Shi to Nageki to Kaze no Miyako ~Ilion~/死と嘆きと風の都",
    "Moira - Seinaru Shijin no Shima ~Lesbos~/聖なる詩人の島",
    "Moira - Haruka Chiheisen no Kanata e ~Horizontas~/遥か地平線の彼方へ",
    "Moira - Shiseru Monotachi no Monogatari ~Istoria~/死せる者達の物語",
    "Moira - Hoshi Megami no Miko ~Artemisia~/星女神の巫女",
    "Moira - Shiseru Otome Sono Te ni wa Suigetsu ~Parthenos~/死せる乙女その手には水月",
    "Moira - Doreitachi no Eiyuu ~Elefseus~/奴隷達の英雄",
    "Moira - Shiseru Eiyuutachi no Tatakai ~Heromachia~/死せる英雄達の戦い",
    "Moira - Shinwa no Shuuen ~Telos~/神話の終焉",
    "Moira - Kami no Hikari ~Moira~/神の光",
    "Marchen - Yoiyami no Uta/宵闇の唄",
    "Marchen - Kakei no Majo/火刑の魔女",
    "Marchen - Kuroki Okami no Yado/黒き女将の宿",
    "Marchen - Garasu no Hitsugi de Nemuru Himegimi/硝子の棺で眠る姫君",
    "Marchen - Sei to Shi wo Wakatsu Kyoukai no Furuido/生と死を別つ境界の古井戸",
    "Marchen - Bara no Tou de Nemuru Himegimi/薔薇の塔で眠る姫君",
    "Marchen - Aoki Hakushaku no Shiro/青き伯爵の城",
    "Marchen - Takkei no Seijo/磔刑の聖女",
    "Marchen - Gyoukou no Uta/暁光の唄",
    "Marchen - Silence (Bonus Track)/ボーナストラック",
    "Nein - Ori no Naka no Hakoniwa/檻の中の箱庭",
    "Nein - Namonaki Onna no Uta/名もなき女の詩",
    "Nein - Shokumotsu ga Tsuranaru Sekai/食物が連なる世界",
    "Nein - Ienakatta Kotonoha/言えなかったの言の葉",
    "Nein - Nikushimi wo Hanataba ni Kaete/憎しみを花束に代えて",
    "Nein - Seiyou Kottou Yaneura Dou/西洋骨董屋根裏堂",
    "Nein - Namida de wa Kesenai Honoo/涙では消せない焔",
    "Nein - Ai to Iu na no Toga/愛という名の咎",
    "Nein - Wasurena Tsukiyo/忘れな月夜",
    "Nein - Rinne/輪廻",
    "Nein - Saihate no L/最果てのL",
    "Chro2nd - Kuro no Yogensho/黒の予言書",
    "Chro2nd - Shijin Ballad no Higeki/詩人バラッドの悲劇",
    "Chro2nd - Tadoritsuku Uta/辿りつく詩",
    "Chro2nd - Arbelge no Tatakai/アーベルジュの戦い",
    "Chro2nd - Yakusoku no Oka/約束の丘",
    "Chro2nd - Bara no Kishidan/薔薇の騎士団",
    "Chro2nd - Seisen to Shinigami 1/聖戦と死神第１部",
    "Chro2nd - Seisen to Shinigami 2/聖戦と死神第２部",
    "Chro2nd - Seisen to Shinigami 3/聖戦と死神第３部",
    "Chro2nd - Seisen to Shinigami 4/聖戦と死神第４部",
    "Chro2nd - Sho no Sasayaki/書の囁き",
    "Chro2nd - Ao to Shiro no Kyoukaisen/蒼と白の境界線",
    "Chro2nd - Shizunda Utahime/沈んだ歌姫",
    "Chro2nd - Umi no Majo/海の魔女",
    "Chro2nd - Aoi Me no Kaizoku/碧い目の海賊",
    "Chro2nd - Raijin no Hidari Ude/雷神の左腕",
    "Chro2nd - Raijin no Keifu/雷神の系譜",
    "Chro2nd - Sho no Majuu/書の魔獣",
    "Chro2nd - Kimi ga Umaretekuru Sekai/キミが生まれてくる世界",
    "Chro2nd - Hajimari no Chronicle/＜ハジマリ＞のChronicle",
    "Chro2nd - Kuuhaku no Chronicle/＜空白＞のChronicle",
    "Chro2nd - Raijin no Migi Ude/雷神の右腕",
    "Shounen no Tsurugi wo - Shuutan no Ou to Isekai no Kishi ~The Endia & The Knights~/終端の王と異世界の騎士",
    "Shounen no Tsurugi wo - Kamigami ga Aishita Rakuen ~Belle Isle~/神々が愛した楽園",
    "Shounen no Tsurugi wo - Ending (Bonus Track)/ボーナストラック",
    "Another Roman - Asa to Yoru no Monogatari ~Another Roman Mix~/朝と夜の物語",
    "Seisen no Iberia - Arasoi no Keifu/争いの系譜",
    "Seisen no Iberia - Ishidatami no Akaki Akuma/石畳の紅き悪魔",
    "Seisen no Iberia - Shinryaku Suru Mono Sareru Mono/侵略する者される者",
    "IdoIdo - Hikari to Yami no Douwa/光と闇の童話",
    "IdoIdo - Kono Semai Torikago no Naka de/この狭い鳥籠の中で",
    "IdoIdo - Kanojo ga Majo ni Natta Riyuu/彼女が魔女になった理由",
    "IdoIdo - Kuroki Shi no Koushin/黒き死の行進",
    "IdoIdo - Therese, Moshiku wa Elise no Tame ni.../テレーゼ、もしくはエリーゼの為に…",
    "Halloween to Yoru no Monogatari - Hoshi no Kirei na Yoru/星の綺麗な夜",
    "Halloween to Yoru no Monogatari - Asa Made Halloween/朝までハロウィン",
    "Halloween to Yoru no Monogatari - Oyasumi, Lenny/おやすみレニー",
    "Halloween to Yoru no Monogatari - Lenny ga Ita Kisetsu/レニーがいた季節",
    "Halloween to Yoru no Monogatari - Eien no Halloween/永遠のハロウィン",
    "Vanishing Starlight - Yodaka no Hoshi/よだかの星",
    "Vanishing Starlight - Mother",
    "Vanishing Starlight - Interview with Noel",
    "Marvelous Shouchuu - Sunawachi... Hikari wo Mo Nigasanu Ankoku no Chou Juu Ryoku/即ち･･･光をも逃がさぬ暗黒の超重力",
    "Marvelous Shouchuu - Sunawachi... Seikanchou Tunnel/即ち･･･星間超トンネル",
    "Marvelous Shouchuu - Sunawachi... Shouwakusei wo Kurau Chou Kouen/即ち･･･小惑星を食らう超紅炎",
    "Ema ni Negai wo! - Hoshizora e to Tsuzuku Sakamichi/星空へと続く坂道",
		"Ema ni Negai wo! - Rouran Jinja/狼欒神社",
		"Ema ni Negai wo! - Yoru no Karma ga Miseta Yume/夜の因業が見せた夢",
		"Ema ni Negai wo! - Shokuzai to 《Homura》 no Ibuki/贖罪と《焔》の息吹",
		"Ema ni Negai wo! - Kurayami wo Terasu HIKARI/暗闇を照らすヒカリ",
		"Ema ni Negai wo! - Watashi no Umareta 《Sekai》/私の生まれた《地平線》",
		"Ema ni Negai wo! - Ikiteiru no wa BOKU Dake Nandaro?/生きているのはボクだけなんだろ？",
		"Ema ni Negai wo! - Koi wa Hate Made Tomaranai/恋は果てまで止まらない",
		"Ema ni Negai wo! - Nishikaze no You ni Kakenukero!!/西風のように駆け抜けろッ！",
    "[LH] Luxendarc Daikikou - Theme of the Linked Horizon",
    "[LH] Luxendarc Daikikou - Luxendarc Kikou/ルクセンダルク紀行",
    "[LH] Luxendarc Daikikou - Utsuro na Tsuki no Shita de/虚ろな月の下で",
    "[LH] Luxendarc Daikikou - Kimi wa Boku no Kibou/君は僕の希望",
    "[LH] Luxendarc Daikikou - Kaze no Yukue/風の行方",
    "[LH] Luxendarc Daikikou - Hinadori/雛鳥",
    "[LH] Luxendarc Daikikou - Ai no Hourousha/愛の放浪者",
    "[LH] Luxendarc Daikikou - Jun'ai Juuji Houka/純愛十字砲火",
    "[LH] Luxendarc Daikikou - Hana ga Chiru Sekai/花が散る世界",
    "[LH] Luxendarc Daikikou - Miko no Inori/巫女の祈り",
    "[LH] Luxendarc Daikikou - Kibou e Mukau Ballad/希望へ向かう譚詩曲",
    "[LH] Luxendarc Daikikou - PIKO PIKO Sentoukyoku MEDLEY/ピコピコ戦闘曲メドレー",
    "[LH] Jiyuu e no Shingeki - Moshi Kono Kabe no Naka ga Ikken no Ie da to Shitara/もしこの壁の中が一軒の家だとしたら",
    "[LH] Shingeki no Kiseki - Nikagetsu go no Kimi e/二ヶ月後の君へ",
		"[LH] Shingeki no Kiseki - Guren no Yumiya/紅蓮の弓矢",
		"[LH] Shingeki no Kiseki - 14 Moji no Dengon/14文字の伝言",
		"[LH] Shingeki no Kiseki - Guren no Zahyou/紅蓮の座標",
		"[LH] Shingeki no Kiseki - Saigo no Senka/最期の戦果",
		"[LH] Shingeki no Kiseki - Kami no Miwaza/神の御業",
		"[LH] Shingeki no Kiseki - Jiyuu no Tsubasa/自由の翼",
		"[LH] Shingeki no Kiseki - Souyoku no HIKARI/双翼のヒカリ",
		"[LH] Shingeki no Kiseki - Jiyuu no Daishou/自由の代償",
		"[LH] Shingeki no Kiseki - Kanojo wa Tsumetai Hitsugi no Naka de/彼女は冷たい棺の中で",
		"[LH] Shingeki no Kiseki - Shinzou wo Sasageyo!/心臓を捧げよ！",
		"[LH] Shingeki no Kiseki - Guren no Tomoshibi wo Matoi Suiheisen no Kanata e to (Bonus Track)/紅蓮の灯を纏い水平線の彼方へと",
		"[LH] Shingeki no Kiseki - Seishun wa Hanabi no You ni/青春は花火のように",
    "[LH] Rakuen e no Shingeki - Tasogare no Rakuen/黄昏の楽園",
		"[LH] Rakuen e no Shingeki - Kakumei no Yoru ni/革命の夜に",
		"[LH] Rakuen e no Shingeki - Akatsuki no Requiem/暁の鎮魂歌",
    "[LH] Shinjitsu e no Shingeki - Shoukei to Shikabane no Michi/憧憬と屍の道",
		"[LH] Shinjitsu e no Shingeki - 13 no Fuyu/13の冬",
    "Leviathan - March After Millennium",
		"Leviathan - Henkyou kara no Seikansha/辺境からの生還者",
		"Leviathan - Shoujo Iwaku Tenshi/少女曰く天使",
		"Leviathan - Merutokia no Joou/メルトキアの女王",
		"Leviathan - Shoukan to iu Gishiki/召喚という儀式",
		"Leviathan - Shikeishikkou/死刑執行",
		"Leviathan - Voodoo no Shinzou/ブードゥーの心臓",
		"Leviathan - Satsuki no Hakoniwa/さつきの箱庭",
		"Leviathan - Suna no Shiro/砂の城",
		"Leviathan - The Beast of the Endness",
    "Poca felicità - La ragazza col fucile ~ Shoujo to Juu ~/少女と銃 ",
		"Poca felicità - Il fratello ~ Keimai ni Sasageru Gengaku Shijuusou ~/『兄妹』に捧げる弦楽四重奏",
		"Poca felicità - Lui si chiama... ~ Watashi no Taisetsu na Hito... Kare no Na wa... ~/私の大切な人...彼の名は...",
		"Poca felicità - La principessa del regno del sole ~ Mujaki na Ohimesama ~/無邪気なお姫様",
		"Poca felicità - Biancaneve bruno ~ Shirayukihime to 8-nin no Kobito ~/白雪姫と８人の小人",
		"Poca felicità - Pinocchio ~ Koroshiya Pinokkio ~/殺し屋ピノッキオ",
		"Poca felicità - Claes tranquillo ~ Megane to Hitotsu no Yakusoku ~/眼鏡と1つの約束",
		"Poca felicità - La principessa del regno della pasta ~ Kawaisou na Ohimesama ~/可哀想なお姫様",
		"Poca felicità - Io mi chiamo... ~ Anata Dake no Gitai... Watashi no Na wa... ~/貴方だけの義体...私の名は...",
		"Poca felicità - La ragazza ~ Shoujo ni Sasageru Piano Dokusou ~/『少女』に捧げるピアノ独奏",
		"Poca felicità - La ragazza col fucile e poca felicita ~Shoujo to Juu to Chiisana Shiawase ~/少女と銃と小さな幸せ",
    ]),
    On = {
      //song list SPOILERS
      //song list SPOILERS
      ...
      subscribe: ue(
        [
          {
            url: "https://soundcloud.com/dummyrora/icjwifdvsysw",
            answer: "Marchen - Kuroki Okami no Yado/黒き女将の宿", //1
          },
          {
            url: "https://soundcloud.com/dummyrora/52fa7rdx5efw",
            answer: "Lost - Yurikago/ゆりかご", //2
          },
          {
            url: "https://soundcloud.com/dummyrora/hcnkcfyygavx",
            answer: "Thanatos - Sango no Shiro/珊瑚の城", //3
          },
          {
            url: "https://soundcloud.com/dummyrora/lesvos",
            answer: "Moira - Seinaru Shijin no Shima ~Lesbos~/聖なる詩人の島", //4
          },
          {
            url: "https://soundcloud.com/dummyrora/zjxuipwkji3p",
            answer: "Roman - Norowareshi Houseki/呪われし宝石", //5
          },
          {
            url: "https://soundcloud.com/dummyrora/bvfpv88ubegn",
            answer: "Marchen - Yoiyami no Uta/宵闇の唄", //6
          },
          {
            url: "https://soundcloud.com/dummyrora/87dvpgkb1901",
            answer: "Nein - Ai to Iu na no Toga/愛という名の咎", //7
          },
          {
            url: "https://soundcloud.com/dummyrora/side-e",
            answer: "Elysion - Eru no Rakuen [Side:E]/エルの楽園［→side:E→］", //8
          },
          {
            url: "https://soundcloud.com/dummyrora/ewo4ktnqslfr",
            answer: "Thanatos - Giniro no Basha/銀色の馬車", //9
          },
          {
            url: "https://soundcloud.com/dummyrora/doyloi",
            answer: "Moira - Dorei Ichiba ~Douloi~/奴隷市場", //10
          },
          {
            url: "https://soundcloud.com/dummyrora/c4ncyyeh0cul",
            answer: "Halloween to Yoru no Monogatari - Lenny ga Ita Kisetsu/レニーがいた季節", //11
          },
          {
            url: "https://soundcloud.com/dummyrora/mother",
            answer: "Vanishing Starlight - Mother", //12
          },
          {
            url: "https://soundcloud.com/dummyrora/sbsxo2pl8ico",
            answer: "Roman - Asa to Yoru no Monogatari/朝と夜の物語", //13
          },
          {
            url: "https://soundcloud.com/dummyrora/tv1oc5fi2st5",
            answer: "IdoIdo - Kono Semai Torikago no Naka de/この狭い鳥籠の中で", //14
          },
          {
            url: "https://soundcloud.com/dummyrora/pudldgeuehcd",
            answer: "Nein - Seiyou Kottou Yaneura Dou/西洋骨董屋根裏堂", //15
          },
          {
            url: "https://soundcloud.com/dummyrora/jzaydd5qndl0",
            answer: "Thanatos - Kowareta Marionette/壊れたマリオネット", //16
          },
          {
            url: "https://soundcloud.com/dummyrora/the-endia-the-knights",
            answer: "Shounen no Tsurugi wo - Shuutan no Ou to Isekai no Kishi ~The Endia & The Knights~/終端の王と異世界の騎士", //17
          },
          {
            url: "https://soundcloud.com/dummyrora/u97c5ezx49xy",
            answer: "Elysion - Eru no Ehon ~Majo to Lafrenze~/エルの絵本【魔女とラフレンツェ】", //18
          },
          {
            url: "https://soundcloud.com/dummyrora/rlalxpfdo1gr",
            answer: "IdoIdo - Therese, Moshiku wa Elise no Tame ni.../テレーゼ、もしくはエリーゼの為に…", //19
          },
          {
            url: "https://soundcloud.com/dummyrora/bw1wb0j3vhcc",
            answer: "Roman - Yaneura Monogatari/屋根裏物語", //20
          },
          {
            url: "https://soundcloud.com/dummyrora/ljybeuz40xvz",
            answer: "Halloween to Yoru no Monogatari - Oyasumi, Lenny/おやすみレニー", //21
          },
          {
            url: "https://soundcloud.com/dummyrora/l",
            answer: "Nein - Saihate no L/最果てのL", //22
          },
          {
            url: "https://soundcloud.com/dummyrora/ct5h4opmcm8s",
            answer: "Chro2nd - Bara no Kishidan/薔薇の騎士団", //23
          },
          {
            url: "https://soundcloud.com/dummyrora/isyjh4jf7usw",
            answer: "Roman - Miezaru Ude/見えざる腕", //24
          },
          {
            url: "https://soundcloud.com/dummyrora/interview-with-noel",
            answer: "Vanishing Starlight - Interview with Noel", //25
          },
          {
            url: "https://soundcloud.com/dummyrora/reloaded",
            answer: "Reloaded - ...Reloaded", //26
          },
          {
            url: "https://soundcloud.com/dummyrora/moira",
            answer: "Moira - Kami no Hikari ~Moira~/神の光", //27
          },
          {
            url: "https://soundcloud.com/dummyrora/ysv6sjhpqnaa",
            answer: "Chro2nd - Kimi ga Umaretekuru Sekai/キミが生まれてくる世界", //28
          },
          {
            url: "https://soundcloud.com/dummyrora/l7rx71crxblk",
            answer: "IdoIdo - Kuroki Shi no Koushin/黒き死の行進", //29
          },
          {
            url: "https://soundcloud.com/dummyrora/another-roman-mix",
            answer: "Another Roman - Asa to Yoru no Monogatari ~Another Roman Mix~/朝と夜の物語", //30
          },
          {
            url: "https://soundcloud.com/dummyrora/mythos",
            answer: "Moira - Shinwa ~Mythos~/神話", //31
          },
          {
            url: "https://soundcloud.com/dummyrora/ark",
            answer: "Elysion - Ark", //32
          },
          {
            url: "https://soundcloud.com/dummyrora/m4hi9hcsbtza",
            answer: "IdoIdo - Hikari to Yami no Douwa/光と闇の童話", //33
          },
          {
            url: "https://soundcloud.com/dummyrora/jikawppuwmnb",
            answer: "Chro2nd - Kuro no Yogensho/黒の予言書", //34
          },
          {
            url: "https://soundcloud.com/dummyrora/sound-horizon-mode-lost",
            answer: "Lost - Sound Horizon [mode：Lost]", //35
          },
          {
            url: "https://soundcloud.com/dummyrora/dbflxvoxfc8l",
            answer: "Nein - Namida de wa Kesenai Honoo/涙では消せない焔", //36
          },
          {
            url: "https://soundcloud.com/dummyrora/uvti1zyglqrn",
            answer: "Roman - Honoo/焔", //37
          },
          {
            url: "https://soundcloud.com/dummyrora/gmfbu2v3d0rq",
            answer: "Reloaded - Yaneura no Shoujo/屋根裏の少女", //38
          },
          {
            url: "https://soundcloud.com/dummyrora/kvzjdsrjc9eh",
            answer: "Vanishing Starlight - Yodaka no Hoshi/よだかの星", //39
          },
          {
            url: "https://soundcloud.com/dummyrora/thanatos",
            answer: "Moira - Meiou ~Thanatos~/冥王", //40
          },
          {
            url: "https://soundcloud.com/dummyrora/shc9qab76fj2",
            answer: "Chro2nd - Aoi Me no Kaizoku/碧い目の海賊", //41
          },
          {
            url: "https://soundcloud.com/dummyrora/6pqxblitbthe",
            answer: "Lost - Ushinawareshi Uta/失われし詩", //42
          },
          {
            url: "https://soundcloud.com/dummyrora/jdaadj8gjegt",
            answer: "Nein - Wasurena Tsukiyo/忘れな月夜", //43
          },
          {
            url: "https://soundcloud.com/dummyrora/ending",
            answer: "Elysion - Track 44 (Bonus Track)/ボーナストラック", //44
          },
          {
            url: "https://soundcloud.com/dummyrora/avq3iurpla6s",
            answer: "Lost - Ori no Naka no Yuugi/檻の中の遊戯", //45
          },
          {
            url: "https://soundcloud.com/dummyrora/izmhn0pzfsef",
            answer: "Seisen no Iberia - Shinryaku Suru Mono Sareru Mono/侵略する者される者", //46
          },
          {
            url: "https://soundcloud.com/dummyrora/em1rlco8dzvz",
            answer: "Halloween to Yoru no Monogatari - Asa Made Halloween/朝までハロウィン", //47
          },
          {
            url: "https://soundcloud.com/dummyrora/01-sound-horizon-black",
            answer: "Chronicle - Black Chronicle", //48
          },
          {
            url: "https://soundcloud.com/dummyrora/aizy0t7n0yb5",
            answer: "Reloaded - Ori no Naka no Hana/檻の中の花", //49
          },
          {
            url: "https://soundcloud.com/dummyrora/sound-horizon",
            answer: "Chronicle - Sound Horizon", //50
          },
          {
            url: "https://soundcloud.com/dummyrora/7wfcjikyt3or",
            answer: "Marchen - Kakei no Majo/火刑の魔女", //51
          },
          {
            url: "https://soundcloud.com/dummyrora/orizontas",
            answer: "Moira - Haruka Chiheisen no Kanata e ~Horizontas~/遥か地平線の彼方へ", //52
          },
          {
            url: "https://soundcloud.com/dummyrora/vhjiwabrd9u3",
            answer: "Chro2nd - Shijin Ballad no Higeki/詩人バラッドの悲劇", //53
          },
          {
            url: "https://soundcloud.com/dummyrora/7hbbujwttyqh",
            answer: "Marchen - Garasu no Hitsugi de Nemuru Himegimi/硝子の棺で眠る姫君", //54
          },
          {
            url: "https://soundcloud.com/dummyrora/clxxct6ajuje",
            answer: "Seisen no Iberia - Arasoi no Keifu/争いの系譜", //55
          },
          {
            url: "https://soundcloud.com/dummyrora/svj9yfybfm9u",
            answer: "Chro2nd - Sho no Majuu/書の魔獣", //56
          },
          {
            url: "https://soundcloud.com/dummyrora/theme-of-the-linked-horizon?in=dummyrora/sets/luxendarc-daikikou",
            answer: "[LH] Luxendarc Daikikou - Theme of the Linked Horizon",
          },
          {
            url: "https://soundcloud.com/dummyrora/rouran-jinja?in=dummyrora/sets/ema",
            answer: "Ema ni Negai wo! - Rouran Jinja/狼欒神社",
          },
          {
            url: "https://soundcloud.com/dummyrora/vdqg6uvfcy5r",
            answer: "Thanatos - Thanatos no Gensou/タナトスの幻想",
          },
          {
            url: "https://soundcloud.com/dummyrora/v8rjuiweh5rw?in=dummyrora/sets/shinseki",
            answer: "[LH] Shingeki no Kiseki - Shinzou wo Sasageyo!/心臓を捧げよ！",
          },
          {
            url: "https://soundcloud.com/dummyrora/belle-isle",
            answer: "Shounen no Tsurugi wo - Kamigami ga Aishita Rakuen ~Belle Isle~/神々が愛した楽園",
          },
          {
            url: "https://soundcloud.com/dummyrora/1a1",
            answer: "Chro2nd - Seisen to Shinigami 1/聖戦と死神第１部",
          },
          {
            url: "https://soundcloud.com/dummyrora/the-beast-of-the-endness?in=dummyrora/sets/leviathan",
            answer: "Leviathan - The Beast of the Endness",
          },
          {
            url: "https://soundcloud.com/dummyrora/ysxk1gpakrg2",
            answer: "IdoIdo - Kanojo ga Majo ni Natta Riyuu/彼女が魔女になった理由",
          },
          {
            url: "https://soundcloud.com/dummyrora/eleyseys",
            answer: "Moira - Doreitachi no Eiyuu ~Elefseus~/奴隷達の英雄",
          },
          {
            url: "https://soundcloud.com/dummyrora/la-ragazza-col-fucile?in=dummyrora/sets/poca",
            answer: "Poca felicità - La ragazza col fucile ~ Shoujo to Juu ~/少女と銃 ",
          },
          {
            url: "https://soundcloud.com/dummyrora/a8thryk1mlkr",
            answer: "Marchen - Silence (Bonus Track)/ボーナストラック",
          },
          {
            url: "https://soundcloud.com/dummyrora/shokuzai-to-homura-no-ibuki?in=dummyrora/sets/ema",
            answer: "Ema ni Negai wo! - Shokuzai to 《Homura》 no Ibuki/贖罪と《焔》の息吹",
          },
          {
            url: "https://soundcloud.com/dummyrora/14a1?in=dummyrora/sets/shinseki",
            answer: "[LH] Shingeki no Kiseki - 14 Moji no Dengon/14文字の伝言",
          },
          {
            url: "https://soundcloud.com/dummyrora/ilion",
            answer: "Moira - Shi to Nageki to Kaze no Miyako ~Ilion~/死と嘆きと風の都",
          },
          {
            url: "https://soundcloud.com/dummyrora/l2b0izdvatmt",
            answer: "Lost - Eien no Shounen/永遠の少年",
          },
          {
            url: "https://soundcloud.com/dummyrora/5-day-dream-1?in=dummyrora/sets/leviathan",
            answer: "Leviathan - Satsuki no Hakoniwa/さつきの箱庭",
          },
          {
            url: "https://soundcloud.com/dummyrora/1fxnqtngcsse",
            answer: "Roman - Hoshikuzu no Kawahimo/星屑の革紐",
          },
          {
            url: "https://soundcloud.com/dummyrora/ending",
            answer: "Elysion - Track 44 (Bonus Track)/ボーナストラック",
          },
          {
            url: "https://soundcloud.com/dummyrora/kakumei-no-yoru-ni?in=dummyrora/sets/rakuen-e-no-shingeki",
            answer: "[LH] Rakuen e no Shingeki - Kakumei no Yoru ni/革命の夜に",
          },
          {
            url: "https://soundcloud.com/dummyrora/8mqr8sk696id",
            answer: "Marchen - Sei to Shi wo Wakatsu Kyoukai no Furuido/生と死を別つ境界の古井戸",
          },
          {
            url: "https://soundcloud.com/dummyrora/nishikaze-no-you-ni-kakenukero?in=dummyrora/sets/ema",
            answer: "Ema ni Negai wo! - Nishikaze no You ni Kakenukero!!/西風のように駆け抜けろッ！",
          },
          {
            url: "https://soundcloud.com/dummyrora/vocalized-version-1?in=dummyrora/sets/luxendarc-daikikou",
            answer: "[LH] Luxendarc Daikikou - Ai no Hourousha/愛の放浪者",
          },
          {
            url: "https://soundcloud.com/dummyrora/leontiys",
            answer: "Moira - Raijin Iki no Eiyuu ~Leontius~/雷神域の英雄",
          },
          {
            url: "https://soundcloud.com/dummyrora/bk6m1k9nq87v",
            answer: "Seisen no Iberia - Ishidatami no Akaki Akuma/石畳の紅き悪魔",
          },
          {
            url: "https://soundcloud.com/dummyrora/march-after-millennium?in=dummyrora/sets/leviathan",
            answer: "Leviathan - March After Millennium",
          },
          {
            url: "https://soundcloud.com/dummyrora/artemisia",
            answer: "Moira - Hoshi Megami no Miko ~Artemisia~/星女神の巫女",
          },
          {
            url: "https://soundcloud.com/dummyrora/3a1",
            answer: "Chro2nd - Seisen to Shinigami 3/聖戦と死神第３部",
          },
          {
            url: "https://soundcloud.com/dummyrora/biancaneve-bruno-8?in=dummyrora/sets/poca",
            answer: "Poca felicità - Biancaneve bruno ~ Shirayukihime to 8-nin no Kobito ~/白雪姫と８人の小人",
          },
          {
            url: "https://soundcloud.com/dummyrora/kurayami-o-terasu-hikari?in=dummyrora/sets/ema",
            answer: "Ema ni Negai wo! - Kurayami wo Terasu HIKARI/暗闇を照らすヒカリ",
          },
          {
            url: "https://soundcloud.com/dummyrora/ukk67y6o1n6g",
            answer: "Thanatos - Rinne no Sunadokei/輪廻の砂時計"
          },
          {
            url: "https://soundcloud.com/dummyrora/13a1?in=dummyrora/sets/shinjitsu-e-no-shingeki",
            answer: "[LH] Shinjitsu e no Shingeki - 13 no Fuyu/13の冬",
          },
          {
            url: "https://soundcloud.com/dummyrora/prdt19ynqug0",
            answer: "Chro2nd - Shizunda Utahime/沈んだ歌姫",
          },
          {
            url: "https://soundcloud.com/dummyrora/dwb8glix8v0q",
            answer: "Nein - Nikushimi wo Hanataba ni Kaete/憎しみを花束に代えて",
          },
          {
            url: "https://soundcloud.com/dummyrora/secret-track?in=dummyrora/sets/shinseki",
            answer: "[LH] Shingeki no Kiseki - Guren no Tomoshibi wo Matoi Suiheisen no Kanata e to (Bonus Track)/紅蓮の灯を纏い水平線の彼方へと",
          },
          {
            url: "https://soundcloud.com/dummyrora/ikiteiru-no-wa-boku-dake?in=dummyrora/sets/ema",
            answer: "Ema ni Negai wo! - Ikiteiru no wa BOKU Dake Nandaro?/生きているのはボクだけなんだろ？",
          },
          {
            url: "https://soundcloud.com/dummyrora/08-sound-horizon",
            answer: "Chronicle - Juhyou no Kimi ~Itetsuita Majo/樹氷の君～凍てついた魔女",
          },
          {
            url: "https://soundcloud.com/dummyrora/pkzv0n6t1xvg",
            answer: "[LH] Jiyuu e no Shingeki - Moshi Kono Kabe no Naka ga Ikken no Ie da to Shitara/もしこの壁の中が一軒の家だとしたら",
          },
          {
            url: "https://soundcloud.com/dummyrora/ending-1",
            answer: "Shounen no Tsurugi wo - Ending (Bonus Track)/ボーナストラック",
          },
          {
            url: "https://soundcloud.com/dummyrora/byoqkjj05qen",
            answer: "Elysion - Eru no Shouzou/エルの肖像",
          },
          {
            url: "https://soundcloud.com/dummyrora/vocalized-version-5?in=dummyrora/sets/luxendarc-daikikou",
            answer: "[LH] Luxendarc Daikikou - Utsuro na Tsuki no Shita de/虚ろな月の下で",
          },
          {
            url: "https://soundcloud.com/dummyrora/cjc0midfco0e",
            answer: "Lost - Hiiro no Hana/緋色の花",
          },
          {
            url: "https://soundcloud.com/dummyrora/4a1",
            answer: "Chro2nd - Seisen to Shinigami 4/聖戦と死神第４部",
          },
          {
            url: "https://soundcloud.com/dummyrora/vum60cvuzfyq?in=dummyrora/sets/shinseki",
            answer: "[LH] Shingeki no Kiseki - Kanojo wa Tsumetai Hitsugi no Naka de/彼女は冷たい棺の中で",
          },
          {
            url: "https://soundcloud.com/dummyrora/istoria",
            answer: "Moira - Shiseru Monotachi no Monogatari ~Istoria~/死せる者達の物語",
          },
          {
            url: "https://soundcloud.com/dummyrora/fikojm1ensuo",
            answer: "Halloween to Yoru no Monogatari - Hoshi no Kirei na Yoru/星の綺麗な夜",
          },
          {
            url: "https://soundcloud.com/dummyrora/lui-si-chiama?in=dummyrora/sets/poca",
            answer: "Poca felicità - Lui si chiama... ~ Watashi no Taisetsu na Hito... Kare no Na wa... ~/私の大切な人...彼の名は...",
          },
          {
            url: "https://soundcloud.com/dummyrora/zdpocahpj2ah",
            answer: "Thanatos - Soko ni Aru Fuukei/そこにある風景",
          },
          {
            url: "https://soundcloud.com/dummyrora/8ewx0qaeaatp",
            answer: "Chro2nd - Tadoritsuku Uta/辿りつく詩",
          },
          {
            url: "https://soundcloud.com/dummyrora/1a2?in=dummyrora/sets/leviathan",
            answer: "Leviathan - Henkyou kara no Seikansha/辺境からの生還者",
          },
          {
            url: "https://soundcloud.com/dummyrora/ujiuxiqckfox",
            answer: "Marchen - Bara no Tou de Nemuru Himegimi/薔薇の塔で眠る姫君",
          },
          {
            url: "https://soundcloud.com/dummyrora/koi-wa-hate-made-tomaranai?in=dummyrora/sets/ema",
            answer: "Ema ni Negai wo! - Koi wa Hate Made Tomaranai/恋は果てまで止まらない",
          },
          {
            url: "https://soundcloud.com/dummyrora/bmz0dtobfpy4?in=dummyrora/sets/shinseki",
            answer: "[LH] Shingeki no Kiseki - Souyoku no HIKARI/双翼のヒカリ",
          },
          {
            url: "https://soundcloud.com/dummyrora/sacrifice",
            answer: "Elysion - Sacrifice",
          },
          {
            url: "https://soundcloud.com/dummyrora/watashi-no-umareta-chiheisen?in=dummyrora/sets/ema",
            answer: "Ema ni Negai wo! - Watashi no Umareta 《Sekai》/私の生まれた《地平線》",
          },
          {
            url: "https://soundcloud.com/dummyrora/long-version?in=dummyrora/sets/luxendarc-daikikou",
            answer:  "[LH] Luxendarc Daikikou - Kibou e Mukau Ballad/希望へ向かう譚詩曲",
          },
          {
            url: "https://soundcloud.com/dummyrora/0dl3z7issjzk",
            answer: "Chro2nd - Raijin no Hidari Ude/雷神の左腕",
          },
          {
            url: "https://soundcloud.com/dummyrora/3gicwckyio0a",
            answer: "Nein - Ienakatta Kotonoha/言えなかったの言の葉",
          },
          {
            url: "https://soundcloud.com/dummyrora/tasogare-no-rakuen?in=dummyrora/sets/rakuen-e-no-shingeki",
            answer: "[LH] Rakuen e no Shingeki - Tasogare no Rakuen/黄昏の楽園",
          },
          {
            url: "https://soundcloud.com/dummyrora/04-sound-horizon",
            answer: "Chronicle - Shijin Ballad no Higeki/詩人バラッドの悲劇",
          },
          {
            url: "https://soundcloud.com/dummyrora/hoshizora-e-to-tsuzuku?in=dummyrora/sets/ema",
            answer: "Ema ni Negai wo! - Hoshizora e to Tsuzuku Sakamichi/星空へと続く坂道",
          },
          {
            url: "https://soundcloud.com/dummyrora/5-day-dream?in=dummyrora/sets/leviathan",
            answer: "Leviathan - Suna no Shiro/砂の城",
          },
          {
            url: "https://soundcloud.com/dummyrora/side-a",
            answer: "Elysion - Eru no Rakuen [Side:A]/エルの楽園［→side:A→］",
          },
          {
            url: "https://soundcloud.com/dummyrora/kfjrolkxywrq",
            answer: "Chro2nd - Yakusoku no Oka/約束の丘",
          },
          {
            url: "https://soundcloud.com/dummyrora/claes-tranquillo-1?in=dummyrora/sets/poca",
            answer: "Poca felicità - Claes tranquillo ~ Megane to Hitotsu no Yakusoku ~/眼鏡と1つの約束",
          },
          {
            url: "https://soundcloud.com/dummyrora/qnemgreo7avy",
            answer: "Lost - Mahoutsukai Sarabant/魔法使いサラバント",
          },
          {
            url: "https://soundcloud.com/dummyrora/yysgvgl4hoqo",
            answer: "Roman - Tenshi no Chouzou/天使の彫像",
          },
          {
            url: "https://soundcloud.com/dummyrora/2a2?in=dummyrora/sets/leviathan",
            answer: "Leviathan - Merutokia no Joou/メルトキアの女王",
          },
          {
            url: "https://soundcloud.com/dummyrora/k5pph6dg0tef",
            answer: "Chro2nd - Sho no Sasayaki/書の囁き",
          },
          {
            url: "https://soundcloud.com/dummyrora/ktozlzytmfpx",
            answer: "Lost - Wasuremono wa Arimasenka/忘レモノハ在リマセンカ",
          },
          {
            url: "https://soundcloud.com/dummyrora/vocalized-version?in=dummyrora/sets/luxendarc-daikikou",
            answer: "[LH] Luxendarc Daikikou - Hana ga Chiru Sekai/花が散る世界",
          },
          {
            url: "https://soundcloud.com/dummyrora/ub2ahhompj8v",
            answer: "Roman - Utsukushiki Mono/美しきもの",
          },
          {
            url: "https://soundcloud.com/dummyrora/09-sound-horizon",
            answer: "Chronicle - Kimi ga Umaretekuru Sekai/キミが生まれてくる世界",
          },
          {
            url: "https://soundcloud.com/dummyrora/d8vbiyowvvwu?in=dummyrora/sets/shinseki",
            answer: "[LH] Shingeki no Kiseki - Kami no Miwaza/神の御業",
          },
          {
            url: "https://soundcloud.com/dummyrora/yoru-no-ingou-ga-miseta-yume?in=dummyrora/sets/ema",
            answer: "Ema ni Negai wo! - Yoru no Karma ga Miseta Yume/夜の因業が見せた夢",
          },
          {
            url: "https://soundcloud.com/dummyrora/rkod3cx1hlcj",
            answer: "Nein - Rinne/輪廻",
          },
          {
            url: "https://soundcloud.com/dummyrora/sound-horizon-mode-thanatos",
            answer: "Thanatos - Sound Horizon [mode：Thanatos]",
          },
          {
            url: "https://soundcloud.com/dummyrora/akatsuki-no-requiem?in=dummyrora/sets/rakuen-e-no-shingeki",
            answer: "[LH] Rakuen e no Shingeki - Akatsuki no Requiem/暁の鎮魂歌",
          },
          {
            url: "https://soundcloud.com/dummyrora/yield",
            answer: "Elysion - Yield",
          },
          {
            url: "https://soundcloud.com/dummyrora/didymoi",
            answer: "Moira - Unmei no Futago ~Didymoi~/運命の双子",
          },
          {
            url: "https://soundcloud.com/dummyrora/il-fratello?in=dummyrora/sets/poca",
            answer: "Poca felicità - Il fratello ~ Keimai ni Sasageru Gengaku Shijuusou ~/『兄妹』に捧げる弦楽四重奏",
          },
          {
            url: "https://soundcloud.com/dummyrora/4onr9kxst77b",
            answer: "Roman - Hiiro no Fuusha/緋色の風車",
          },
          {
            url: "https://soundcloud.com/dummyrora/neq3hq6ot1dr",
            answer: "Chro2nd - Arbelge no Tatakai/アーベルジュの戦い",
          },
          {
            url: "https://soundcloud.com/dummyrora/r4dh7ntomhde?in=dummyrora/sets/shinseki",
            answer: "[LH] Shingeki no Kiseki - Seishun wa Hanabi no You ni/青春は花火のように",
          },
          {
            url: "https://soundcloud.com/dummyrora/ysaitwo03brv",
            answer: "Marchen - Takkei no Seijo/磔刑の聖女",
          },
          {
            url: "https://soundcloud.com/dummyrora/uxv6iaidh2xz",
            answer: "Elysion - Eru no Ehon ~Fuebuki Otoko to Parade~/エルの絵本【笛吹き男とパレード】",
          },
          {
            url: "https://soundcloud.com/dummyrora/vocalized-version-2?in=dummyrora/sets/luxendarc-daikikou",
            answer: "[LH] Luxendarc Daikikou - Hinadori/雛鳥",
          },
          {
            url: "https://soundcloud.com/dummyrora/7rz5cyx43euu",
            answer: "Nein - Namonaki Onna no Uta/名もなき女の詩",
          },
          {
            url: "https://soundcloud.com/dummyrora/iromachia",
            answer: "Moira - Shiseru Eiyuutachi no Tatakai ~Heromachia~/死せる英雄達の戦い",
          },
          {
            url: "https://soundcloud.com/dummyrora/um2yvqlzbx8y?in=dummyrora/sets/shinseki",
            answer: "[LH] Shingeki no Kiseki - Guren no Yumiya/紅蓮の弓矢",
          },
          {
            url: "https://soundcloud.com/dummyrora/2qbzs7r2bxq2",
            answer: "Roman - Yorokobi to Kanashimi no Budoushu/歓びと哀しみの葡萄酒",
          },
          {
            url: "https://soundcloud.com/dummyrora/baroque",
            answer: "Elysion - Baroque",
          },
          {
            url: "https://soundcloud.com/dummyrora/3a3?in=dummyrora/sets/leviathan",
            answer: "Leviathan - Shoukan to iu Gishiki/召喚という儀式",
          },
          {
            url: "https://soundcloud.com/dummyrora/05-sound-horizon",
            answer: "Chronicle - Arbelge no Tatakai/アーベルジュの戦い",	
          },
          {
            url: "https://soundcloud.com/dummyrora/white-illusion",
            answer: "Lost - White Illusion/白の幻影",
          },
          {
            url: "https://soundcloud.com/dummyrora/la-ragazza-col-fucile-e-poca?in=dummyrora/sets/poca",
            answer: "Poca felicità - La ragazza col fucile e poca felicita ~Shoujo to Juu to Chiisana Shiawase ~/少女と銃と小さな幸せ",
          },
          {
            url: "https://soundcloud.com/dummyrora/alwcndszhqp6",
            answer: "Marchen - Gyoukou no Uta/暁光の唄",
          },
          {
            url: "https://soundcloud.com/dummyrora/2a1",
            answer: "Chro2nd - Seisen to Shinigami 2/聖戦と死神第２部",
          },
          {
            url: "https://soundcloud.com/dummyrora/w5dwb2od0hp0?in=dummyrora/sets/shinseki",
            answer:  "[LH] Shingeki no Kiseki - Nikagetsu go no Kimi e/二ヶ月後の君へ",
          },
          {
            url: "https://soundcloud.com/dummyrora/matryoshka",
            answer: "Moira - Jinsei wa Ireko Ningyou ~Matryoshka~/人生は入れ子人形",
          },
          {
            url: "https://soundcloud.com/dummyrora/16pr0r4emyzu",
            answer: "Elysion - Eru no Tenbin/エルの天秤",
          },
          {
            url: "https://soundcloud.com/dummyrora/long-version-1?in=dummyrora/sets/luxendarc-daikikou",
            answer: "[LH] Luxendarc Daikikou - Jun'ai Juuji Houka/純愛十字砲火",
          },
          {
            url: "https://soundcloud.com/dummyrora/06-sound-horizon",
            answer: "Chronicle - Ao to Shiro no Kyoukaisen/蒼と白の境界線",
          },
          {
            url: "https://soundcloud.com/dummyrora/dl3whkdyrdva",
            answer: "Lost - Kioku no Minasoko/記憶の水底",
          },
          {
            url: "https://soundcloud.com/dummyrora/3a2?in=dummyrora/sets/leviathan",
            answer: "Leviathan - Shikeishikkou/死刑執行",
          },
          {
            url: "https://soundcloud.com/dummyrora/qsi6ttgsebhh",
            answer: "Reloaded - Ori no Naka no Yuugi/檻の中の遊戯",
          },
          {
            url: "https://soundcloud.com/dummyrora/chronicle-1",
            answer: "Chro2nd - Hajimari no Chronicle/＜ハジマリ＞のChronicle",
          },
          {
            url: "https://soundcloud.com/dummyrora/la-principessa-del-regno-della?in=dummyrora/sets/poca",
            answer: "Poca felicità - La principessa del regno della pasta ~ Kawaisou na Ohimesama ~/可哀想なお姫様",
          },
          {
            url: "https://soundcloud.com/dummyrora/z5af3geajcvi",
            answer: "Roman - Tasogare no Kenja/黄昏の賢者",
          },
          {
            url: "https://soundcloud.com/dummyrora/0o0dporwpjwi",
            answer: "Nein - Shokumotsu ga Tsuranaru Sekai/食物が連なる世界",
          },
          {
            url: "https://soundcloud.com/dummyrora/4a2?in=dummyrora/sets/leviathan",
            answer: "Leviathan - Voodoo no Shinzou/ブードゥーの心臓",
          },
          {
            url: "https://soundcloud.com/dummyrora/07-sound-horizon",
            answer: "Chronicle - Shoujo Ningyou/少女人形",
          },
          {
            url: "https://soundcloud.com/dummyrora/stardust",
            answer: "Elysion - Stardust",
          },
          {
            url: "https://soundcloud.com/dummyrora/la-principessa-del-regno-del?in=dummyrora/sets/poca",
            answer: "Poca felicità - La principessa del regno del sole ~ Mujaki na Ohimesama ~/無邪気なお姫様",
          },
          {
            url: "https://soundcloud.com/dummyrora/03-sound-horizon",
            answer: "Chronicle - Raijin no Hidari Ude/雷神の左腕",
          },
          {
            url: "https://soundcloud.com/dummyrora/parthenos",
            answer: "Moira - Shiseru Otome Sono Te ni wa Suigetsu ~Parthenos~/死せる乙女その手には水月",
          },
          {
            url: "https://soundcloud.com/dummyrora/vocalized-version-3?in=dummyrora/sets/luxendarc-daikikou",
            answer: "[LH] Luxendarc Daikikou - Kaze no Yukue/風の行方",
          },
          {
            url: "https://soundcloud.com/dummyrora/yfineptobpik",
            answer: "Chro2nd - Ao to Shiro no Kyoukaisen/蒼と白の境界線",
          },
          {
            url: "https://soundcloud.com/dummyrora/x519xhatyf8f",
            answer: "Halloween to Yoru no Monogatari - Eien no Halloween/永遠のハロウィン",
          },
          {
            url: "https://soundcloud.com/dummyrora/la-ragazza?in=dummyrora/sets/poca",
            answer: "Poca felicità - La ragazza ~ Shoujo ni Sasageru Piano Dokusou ~/『少女』に捧げるピアノ独奏",
          },
          {
            url: "https://soundcloud.com/dummyrora/qdoc7zbbp7zt",
            answer: "Lost - Wasuremono/忘レモノ",
          },
          {
            url: "https://soundcloud.com/dummyrora/vhqwqau2qnu0",
            answer: "Marchen - Aoki Hakushaku no Shiro/青き伯爵の城",
          },
          {
            url: "https://soundcloud.com/dummyrora/w8dlee2csvc8?in=dummyrora/sets/shinjitsu-e-no-shingeki",
            answer: "[LH] Shinjitsu e no Shingeki - Shoukei to Shikabane no Michi/憧憬と屍の道",
          },
          {
            url: "https://soundcloud.com/dummyrora/11a1",
            answer: "Roman - 11Moji no Dengon/11文字の伝言",
          },
          {
            url: "https://soundcloud.com/dummyrora/1rryhgqsgm72",
            answer: "Chro2nd - Raijin no Keifu/雷神の系譜",
          },
          {
            url: "https://soundcloud.com/dummyrora/5gkhhsqotvhb?in=dummyrora/sets/luxendarc-daikikou",
            answer: "[LH] Luxendarc Daikikou - Luxendarc Kikou/ルクセンダルク紀行",
          },
          {
            url: "https://soundcloud.com/dummyrora/amhswi7dhvbr",
            answer: "Nein - Ori no Naka no Hakoniwa/檻の中の箱庭",
          },
          {
            url: "https://soundcloud.com/dummyrora/moevwlmkyaqp",
            answer: "Chro2nd - Umi no Majo/海の魔女",
          },
          {
            url: "https://soundcloud.com/dummyrora/zuubykd7nh1g?in=dummyrora/sets/shinseki",
            answer: "[LH] Shingeki no Kiseki - Saigo no Senka/最期の戦果",
          },
          {
            url: "https://soundcloud.com/dummyrora/telos",
            answer: "Moira - Shinwa no Shuuen ~Telos~/神話の終焉",
          },
          {
            url: "https://soundcloud.com/dummyrora/io-mi-chiamo?in=dummyrora/sets/poca",
            answer: "Poca felicità - Io mi chiamo... ~ Anata Dake no Gitai... Watashi no Na wa... ~/貴方だけの義体...私の名は...",
          },
          {
            url: "https://soundcloud.com/dummyrora/2a3?in=dummyrora/sets/leviathan",
            answer: "Leviathan - Shoujo Iwaku Tenshi/少女曰く天使",
          },
          {
            url: "https://soundcloud.com/dummyrora/vocalized-version-4?in=dummyrora/sets/luxendarc-daikikou",
            answer: "[LH] Luxendarc Daikikou - Kimi wa Boku no Kibou/君は僕の希望",
          },
          {
            url: "https://soundcloud.com/dummyrora/3ygar173djdc?in=dummyrora/sets/shinseki",
            answer: "[LH] Shingeki no Kiseki - Guren no Zahyou/紅蓮の座標",
          },
          {
            url: "https://soundcloud.com/dummyrora/pinocchio?in=dummyrora/sets/poca",
            answer: "Poca felicità - Pinocchio ~ Koroshiya Pinokkio ~/殺し屋ピノッキオ",
          },
          {
            url: "https://soundcloud.com/dummyrora/ni9cler8rcyx?in=dummyrora/sets/shinseki",
            answer: "[LH] Shingeki no Kiseki - Jiyuu no Tsubasa/自由の翼",
          },
          {
            url: "https://soundcloud.com/dummyrora/strings-quartet-version?in=dummyrora/sets/luxendarc-daikikou",
            answer: "[LH] Luxendarc Daikikou - Miko no Inori/巫女の祈り",
          },
          {
            url: "https://soundcloud.com/dummyrora/8naaek6n1shc?in=dummyrora/sets/shinseki",
            answer: "[LH] Shingeki no Kiseki - Jiyuu no Daishou/自由の代償",
          },
          {
            url: "https://soundcloud.com/dummyrora/rbeyqdvzq6tv?in=dummyrora/sets/luxendarc-daikikou",
            answer: "[LH] Luxendarc Daikikou - PIKO PIKO Sentoukyoku MEDLEY/ピコピコ戦闘曲メドレー",
          },
        ],
        Pn
      ).subscribe,
    ...
    return {
      c() {
        (t = w("meta")),
          ...
          (C = x()),
          H && H.c(),
          (An.title = "Revo Heardle - Revo song intros game"),
          M(t, "name", "description"),
          M(
            t,
            "content",
            "Guess the Revo song from the intro in as few tries as possible"
          ),
